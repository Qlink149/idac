...
class Settings:
    BRAND_NAME: str = "IDAC"
    WHITELABEL_AGENT_DISPLAY_NAME: str = "IDAC AI Sales Agent"
    PROJECT_NAME: str = "IDAC Sales Intelligence API"
    SECRET_KEY: str = os.environ.get(
        "SECRET_KEY", "idac-secret-key-change-in-production"
    )
    ...
    DB_NAME: str = os.environ.get('DB_NAME', 'idac_db')
